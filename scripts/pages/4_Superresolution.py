...
CONFIG_PATH = os.path.join(PROJECT_PATH,"configs/stable-diffusion/x4-upscaling.yaml")
CHECKPOINT_PATH = os.path.join(PROJECT_PATH,"weight/x4-upscaler-ema.ckpt")
...
# def run():
st.title("Stable Diffusion SuperResolution (Upscaling)")
st.markdown("""
    ## If size of input image is bigger than (384,384), the image will resize to (384,384)
""")
video_file = open('/home/td/Project/stablediffusion/scripts/samples/superresolution.mp4', 'rb')
